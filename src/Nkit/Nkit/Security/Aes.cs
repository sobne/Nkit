...
namespace Nkit.Security
{
    ...
    public class Aes
    {
        ...
        {
            return Encrypt(str, CopyRightExp.PersonalWebSite);
        }
        /// <summary>
        /// AES解密
        /// </summary>
        ...
        {
            return Decrypt(str, CopyRightExp.PersonalWebSite);
        }
        //默认密钥向量
        ...
        public string Decrypt(string str, string key)
        {
            try
            {
                ...
                byte[] inputData = Convert.FromBase64String(str);
        ...
        private string GetSubString(string p_SrcString, int p_StartIndex, int p_Length, string p_TailString)
        {
